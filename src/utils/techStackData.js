 ...
 * and dynamic styling configuration for interactive presentation.
 * 
 * Features category-based organization, detailed descriptions, icon
 * configuration, and responsive design data for optimal display.
 * 
...
import { TECH_STACK } from '../../utils/techStackData'; // UPDATED IMPORT
