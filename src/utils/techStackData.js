/**
 * Technology Stack Data Management
 * 
 * Centralized data structure containing comprehensive technology expertise information
 * for the interactive TechStackSection component. Organizes technical skills by category
 * with detailed descriptions and usage examples to demonstrate practical experience.
 * 
 * Data Structure:
 * - Six main technology categories (languages, frontend, backend, cloud, tools, practices)
 * - Each category contains technologies with description and usage examples
 * - Descriptions explain what the technology is and its primary use cases
 * - Usage examples provide specific context of how it was applied in projects
 * 
 * Professional Context:
 * - Designed for recruiter review and technical screening preparation
 * - Demonstrates breadth and depth of technical knowledge across the full stack
 * - Provides concrete examples of practical application in real projects
 * - Shows progression from academic learning to professional implementation
 * 
 * Maintenance Notes:
 * - Update usage examples as new projects are completed
 * - Add new technologies as skills are acquired
 * - Keep descriptions current with latest technology versions
 * - Ensure usage examples reflect most impressive implementations
 * 
